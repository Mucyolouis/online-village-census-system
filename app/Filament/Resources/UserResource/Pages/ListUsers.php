...
class ListUsers extends ListRecords
{
    ...
    public function getTabs(): array
    {
        ...
        $tabs = [
            ...
            'citizen' => Tab::make()->query(fn ($query) => $query->with('roles')->whereRelation('roles', 'name', '=', 'citizen')),
            'cov' => Tab::make()->query(fn ($query) => $query->with('roles')->whereRelation('roles', 'name', '=', 'cov')),
